    ...
    <div className="space-y-8 max-w-6xl">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 bg-aura-bg/95 sm:bg-aura-bg/90 sm:backdrop-blur-md flex flex-col sm:items-center sm:justify-center sm:p-4 overflow-hidden" data-lenis-prevent="true">
          <div className="w-full h-[100dvh] sm:h-auto sm:max-h-[85vh] sm:max-w-2xl bg-aura-surface sm:border border-aura-gold/30 sm:rounded-2xl p-6 pb-24 sm:pb-8 sm:p-8 space-y-6 relative shadow-2xl shrink-0 overflow-y-auto">
            <button
